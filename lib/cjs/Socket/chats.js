...
exports.makeChatsSocket = exports.buildProfilePictureQueryContent = void 0;
...
const buildProfilePictureQueryContent = (type, tcTokenContent) => {
...
exports.buildProfilePictureQueryContent = buildProfilePictureQueryContent;
const makeChatsSocket = (config) => {
    ...
    const updateBlockStatus = async (jid, action) => {
        ...
        let lid;
        let pn_jid;
        if ((0, WABinary_1.isLidUser)(normalizedJid) || (0, WABinary_1.isHostedLidUser)(normalizedJid)) {
            lid = normalizedJid;
            if (action === 'block') {
                ...
                pn_jid = (0, WABinary_1.jidNormalizedUser)(pn);
            }
        }
        else if ((0, WABinary_1.isPnUser)(normalizedJid) || (0, WABinary_1.isHostedPnUser)(normalizedJid)) {
            ...
            lid = mapped;
            if (action === 'block') {
                pn_jid = (0, WABinary_1.jidNormalizedUser)(normalizedJid);
            }
        }
        else {
    ...
    const profilePictureUrl = async (jid, type = 'preview', timeoutMs) => {
        ...
        const isSelf = me && (normalizedJid === (0, WABinary_1.jidNormalizedUser)(me.id) || (me.lid && normalizedJid === (0, WABinary_1.jidNormalizedUser)(me.lid)));
        let tcTokenContent;
        if (serverProps.profilePicPrivacyToken && isUserJid && !isSelf) {
            tcTokenContent = await (0, tc_token_utils_1.buildTcTokenFromJid)({
                authState,
                jid: normalizedJid,
                getLIDForPN
            });
        ...
        const result = await query({
            ...
            content: (0, exports.buildProfilePictureQueryContent)(type, tcTokenContent)
        }, timeoutMs);
    ...
    const appPatch = async (patchCreate) => {
        ...
        await appStatePatchMutex.mutex(async () => {
            await authState.keys.transaction(async () => {
                ...
                initial = currentSyncVersion ? (0, Utils_1.ensureLTHashStateVersion)(currentSyncVersion) : (0, Utils_1.newLTHashState)();
