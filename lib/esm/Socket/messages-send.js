...
const makeMessagesSocket = (config) => {
    ...
    const devicesMutex = (0, make_mutex_1.makeMutex)();
    ...
    let mediaHost = Utils_1.DEF_MEDIA_HOST;
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        const meId = (0, Utils_1.assertMeId)(authState.creds);
        const meLid = authState.creds.me?.lid;
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isRetryResend) {
                ...
                const encodedMessageToSend = isMe
                    ...
                    : (0, Utils_1.encodeWAMessage)(messageToSend);
            ...
            const tcTokenJid = is1on1Send ? await (0, tc_token_utils_1.resolveTcTokenJid)(destinationJid, getLIDForPN) : destinationJid;
            ...
            const isBotOrPSA = destinationJid === WABinary_1.PSA_WID || (0, WABinary_1.isJidBot)(destinationJid) || (0, WABinary_1.isJidMetaAI)(destinationJid);
            if (is1on1Send &&
                !isProtocolMsg &&
                !isBotOrPSA &&
                    ...
                    if (result) {
                        if (result.error) {
                            ...
                            try {
                                ...
                                content.url = (0, Utils_1.getUrlFromDirectPath)(content.directPath, mediaHost);
